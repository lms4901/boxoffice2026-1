...
/**
 * Generate fallback box office items with fixed absolute release dates (openDt)
 */
export function generateFallbackBoxOfficeList(baseDateStr: string): DailyBoxOfficeItem[] {
  ...
  return [
    ...
    { rnum: "8", rank: "8", rankInten: "0", rankOldAndNew: "NEW", movieCd: "20262381", movieNm: "사랑의 하츄핑", openDt: "2026-07-20", salesAmt: "7866000", salesShare: "0.4", salesInten: "7866000", salesChange: "100", salesAcc: "7866000", audiCnt: "874", audiInten: "874", audiChange: "100", audiAcc: "874", scrnCnt: "4", showCnt: "4" },
